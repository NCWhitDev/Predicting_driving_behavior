...
X = df_train_motion[['AccX', 'AccY', 'AccZ', 'GyroX', 'GyroY', 'GyroZ', "Timestamp"]]
y = df_train_motion['Class']
...
rf_Model = RandomForestClassifier(n_estimators=200, max_features=2, random_state=7, class_weight='balanced')
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.999, random_state=7, stratify=y)
